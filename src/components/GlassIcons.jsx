...
const GlassIcons = ({ items, className }) => {
  ...
  return (
    <div
      className={`grid gap-[3em] grid-cols-3 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 mx-auto py-[3em] overflow-visible ${className || ''}`}
    >
      {items.map((item, index) => (
        ...
        >
          ...
          >
            <span className="m-auto w-[2.5em] h-[2.5em] flex items-center justify-center" aria-hidden="true">
